...
PRODUCER_TOWER_SCORE = 9.0
PRODUCER_LEVEL3_SCORE = 16.0
PRODUCER_UNLOCK_ROUND = 90
PRODUCER_SAFE_HOSTILE_STEP = 7
...
class AI:
    ...
    def _allow_producer_route(self, info: GameInfo) -> bool:
        ...
        if self.front_state < 0:
            return False
        if info.bases[self.side].hp <= info.bases[1 - self.side].hp - 4:
            return False
