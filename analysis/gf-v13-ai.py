...
PRODUCER_TOWER_SCORE = 26.0
PRODUCER_UNLOCK_ROUND = 35
PRODUCER_SAFE_HOSTILE_STEP = 5
PRODUCER_MAX_TOWERS = 2
...
class ForecastNode:
    ...
    def _score_tower_investment(self, towers: Sequence[Tower]) -> float:
        ...
        for tower in towers:
            ...
            if tower.type == TowerType.PRODUCER:
...
class AI:
    ...
    def _producer_count(self, info: GameInfo) -> int:
        return sum(1 for tower in info.towers if tower.player == self.side and tower.type == TowerType.PRODUCER)
